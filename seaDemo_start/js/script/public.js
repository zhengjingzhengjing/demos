...
; (function ($, undefined) {
    $.extend({
        ...
        }, jsonToString: function (object) {//jsonת��string
    ...
    $.fn.extend({
        ...
        /*
         * dom mask     $(dom).mask()
         * @param  {bool}   pFlag  ��������false��λ���������м䣬true���ı�����ԭ��λ��
         */
        mask: function (pFlag) {
    ...
    /**
     * browser internal
     * @cfg {Array} [IsChrome,IsFirefox,IsOpera,IsSafari,IsIE,IsIE6,IsIpad]  ����������bool
     */
    $$.browser = new function () {
        ...
        this.IsIE11 = /rv:11/.test(_userAgent);
