 ...
 *
 * Copyright (c) 2016 small long.  All rights reserved.
 * ? Released under the MIT license.
 *
 * Date: Tue Mar 3 2016
 */
define("glDatePicker",["jquery/jquery"], function(a) {
    var $ = a("jquery")
;(function() {
    ...
    $.fn.glDatePicker.defaults =
    {
        ...
        onClick: (function(el, cell, date, data) {
            date = date.getFullYear() + '-' + ((date.getMonth()+1).toString().length<2?('0'+(date.getMonth()+1)):(date.getMonth()+1)) + '-' + (date.getDate().toString().length<2?'0'+date.getDate():date.getDate());
            el.val(date);
        }),
